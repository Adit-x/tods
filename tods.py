...
|_|  |_|____/|_|  \33[36;1m'  login akun tumbal oghey""")
...
def pilih_masuk():
    ...
    if romi == '':
        ...
        time.sleep(1.0)
        pilih_masuk()
    elif tods == '1' or romi == '01':
        token()
    elif tods == '2' or romi == '02':
        kuki()
    elif tods == '3' or romi == '03':
        tik()
        os.system('xdg-open https://youtu.be/IG5QfdxRkeY')
        os.sys.exit()
    elif tods == '4' or romi == '04':
        tik()
        os.system('xdg-open https://youtu.be/b9crrvr6d2s')
        os.sys.exit()
    elif tods == '0' or romi == '00':
    	print ''
